...
namespace ClassCppToCS_CS
{
  ...
  Console.WriteLine("LAMP");
    ...
    private void button2_Click(object sender, EventArgs e)
    {
      ...
      if (clicked) n_reference_points = chart.Series[0].Points.Count() - 1;
      else n_reference_points = chart.Series[0].Points.Count();
      ...
      if (clicked)
      {
        input_point[0, 0] = schart.Series[0].Points[schart.Series[0].Points.Count - 1].XValue;
        input_point[0, 1] = schart.Series[0].Points[schart.Series[0].Points.Count - 1].YValues[0];
      }
